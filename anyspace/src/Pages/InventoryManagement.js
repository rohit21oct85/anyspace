        ...
        <div className="row">
            <div className="col-lg-4 padding-right">
                ...
                <div className="schedule-appointment">
                  ...
                  <NavLink to="#" className="cta cta__schedule" data-target="#callusNow" data-toggle="modal" >Schedule An Appointment</NavLink>
                </div>
                </div>
            </div>
...
export default PageLayout(InverntoryManagement);