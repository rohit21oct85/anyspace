        ...
        <div className="hero-content">
            <div className="position-div">
                <h1 className="hero__heading">
                   <span className="hero__heading_bold">WAREHOUSE FOR RENT</span> <br /> IN {city}
                </h1>
            ...
            <ul className="hero-breadcrumbs">
                ...
                <li>Warehouse For Rent In {city}</li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div className="row">
            <div className="col-lg-12 col-md-12 col-12">
                <h2 className="warehouse_title">
                    <span className="warehouse_title_bold">WAREHOUSE & GODOWN IN :</span> FAST-TRACK YOUR BUSINESS</h2>
    ...
    <div className="container">
        <div className="row">   
            <div className="col-lg-12 col-md-12 col-12 warehouse-available">
                <h2><span className="warehouse_title_bold">BEST WAREHOUSE IN </span></h2>
...
export default PageLayout(Locationinner);