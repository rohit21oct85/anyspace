        ...
        <div className="row">
            <div className="col-lg-4 padding-right">
                ...
                <div className="schedule-appointment">
                  ...
                  <NavLink to="#" data-toggle="modal" data-target="#callusNow" target="_blank" className="cta cta__schedule">Schedule An Appointment</NavLink>
                </div>
                </div>
            </div>
...
export default PageLayout(DistributionNetwork);